            ...
            foreach ($admin as $ad ) { ?>
                <form action="<?php echo base_url() . 'admin/C_admin/update'; ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="username" class="form-control form-control-user" id="email" name="email" placeholder="Masukan Username" title="Isikan data dengan benar" value="<?php echo $ad->email ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="password"> Password : </label>
                        <input type="password" name="password" class="form-control form-control-user" id="password" placeholder="Masukkan Password" title="Isikn data dengan benar" value="<?php echo $ad->password ?>" required>
                    </div>
                    <hr>
