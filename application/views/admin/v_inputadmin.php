<div class="container-fluid">
            ...
            <div class="col-lg-10">
                <form action="<?php echo base_url() . 'admin/C_admin/tambah_admin'; ?>" method="post">
                    ...
                    <div class="form-group">
                        <label for="useraname"> Email : </label>
                        <input type="username" class="form-control form-control-user" id="email" name="email" placeholder="Masukan Username" title="Isikan data dengan benar" required>
                    </div>
                    <div class="form-group">
